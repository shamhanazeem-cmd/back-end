...
public class PaginatedResponsePaymentDto {
    ...
    public PaginatedResponsePaymentDto() {
    }

    public PaginatedResponsePaymentDto(long count, List<PaymentResponseDto> dataList) {
        this.count = count;
    ...
    public List<PaymentResponseDto> getDataList() { return dataList; }
    public void setDataList(List<PaymentResponseDto> dataList) { this.dataList = dataList; }
