...
public class PaginatedResponseDoctorDto {
    ...
    public PaginatedResponseDoctorDto() {
    }

    public PaginatedResponseDoctorDto(long count, List<DoctorResponseDto> dataList) {
        this.count = count;
    ...
    public List<DoctorResponseDto> getDataList() { return dataList; }
    public void setDataList(List<DoctorResponseDto> dataList) { this.dataList = dataList; }
