...
public class PaginatedResponseTeacherDto {
    ...
    public PaginatedResponseTeacherDto() {
    }

    public PaginatedResponseTeacherDto(long count, List<TeacherResponseDto> dataList) {
        this.count = count;
    ...
    public List<TeacherResponseDto> getDataList() { return dataList; }
    public void setDataList(List<TeacherResponseDto> dataList) { this.dataList = dataList; }
