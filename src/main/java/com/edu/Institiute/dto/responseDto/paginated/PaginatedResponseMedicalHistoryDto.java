...
public class PaginatedResponseMedicalHistoryDto {
    ...
    public PaginatedResponseMedicalHistoryDto() {
    }

    public PaginatedResponseMedicalHistoryDto(long count, List<MedicalHistoryResponseDto> dataList) {
        this.count = count;
    ...
    public List<MedicalHistoryResponseDto> getDataList() { return dataList; }
    public void setDataList(List<MedicalHistoryResponseDto> dataList) { this.dataList = dataList; }
